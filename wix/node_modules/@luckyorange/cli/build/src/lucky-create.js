...
function create() {
    return __awaiter(this, void 0, void 0, function* () {
        program
            ...
            .parse(process.argv);
        // Get templates
        const templates = yield require('./lucky-create-templates')();
        // Template options
        ...
        const tasks = [
            ...
            },
            {
                ...
                task: () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield execa('git config --global hub.protocol https', { shell: true });
                    yield execa('git init', { cwd, shell: true });
                    yield execa(`gh repo create luckyorange/${options.name} --private -d "${options.description}" --source ${cwd}`, { cwd, shell: true });
                })
            },
            {
                ...
                task: () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield copyTemplateDir(copyFrom, cwd, data);
                })
            }
        ];
