- pipeline: "Staging"
  ...
  - action: "Build: Docker Image"
    ...
    repository: "lucky-orange-staging/{{name}}"
    registry: "us.gcr.io"
    build_args:
    - "NPM_TOKEN=${NPM_TOKEN}"
    trigger_condition: "ALWAYS"
  ...
  - action: "Deploy: Kubernetes"
    ...
    zone_id: "{{clusterStaging.zone}}"
    cluster: "{{clusterStaging.name}}"
...
- pipeline: "Docs"
  ...
  - action: "Deploy: Cloud Storage"
    ...
    remote_path: "${project.display_name}"
