- pipeline: "Staging"
  ...
  - action: "Build: Docker Image"
    ...
    repository: "lucky-orange-staging/${project.display_name}"
    registry: "us.gcr.io"
    build_args:
    - "NPM_TOKEN=${NPM_TOKEN}"
    trigger_condition: "ALWAYS"
  ...
  - action: "Execute: lucky build"
    ...
    - "export LO_BUILD_MANIFOLD_TOKEN=${MANIFOLD_TOKEN_STAGING}"
    - "export LO_BUILD_VERSION=${execution.to_revision.revision}"
    - "# Run build script"
    - "npx lucky build"
    mount_filesystem_path: "/buddy/workdir"
    shell: "BASH"
  ...
  - action: "Deploy: Kubernetes"
    ...
    execute_commands:
    - "kubectl apply -f dist/kubernetes/staging.yaml"
    gke_auth_type: "SERVICE_ACCOUNT"
    config_path: "/"
    kubectl_version: "latest"
    validate: true
    trigger_condition: "ALWAYS"
    integration_id: 11267
...
- pipeline: "Production"
  ...
  - action: "Build: Docker Image"
    ...
    docker_image_tag: "${execution.to_revision.revision}"
    dockerfile_path: "Dockerfile"
    repository: "lucky-orange/${project.display_name}"
    registry: "us.gcr.io"
    build_args:
    - "NPM_TOKEN=${NPM_TOKEN}"
    trigger_condition: "ALWAYS"
  ...
  - action: "Execute: lucky build"
    ...
    execute_commands:
    - "# Export ENV variables"
    - "export LO_BUILD_MANIFOLD_TOKEN=${MANIFOLD_TOKEN_PROD}"
    - "export LO_BUILD_VERSION=${execution.to_revision.revision}"
    - "# Run build script"
    - "npx lucky build"
    mount_filesystem_path: "/buddy/workdir"
  ...
  - action: "Deploy: Kubernetes"
    ...
    execute_commands:
    - "kubectl apply -f dist/kubernetes/prod.yaml"
    gke_auth_type: "SERVICE_ACCOUNT"
    config_path: "/"
    kubectl_version: "latest"
    validate: true
...
- pipeline: "Test"
  ...
  - action: "Execute: npm test"
    ...
    docker_image_tag: "8"
    execute_commands:
    - "export MANIFOLD_API_TOKEN=${MANIFOLD_TOKEN_STAGING}"
    - "npm test"
    mount_filesystem_path: "/buddy/workdir"
    shell: "BASH"
    trigger_condition: "ALWAYS"
