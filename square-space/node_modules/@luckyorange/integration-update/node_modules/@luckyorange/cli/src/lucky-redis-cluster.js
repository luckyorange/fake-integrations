...
const totalPods = program.totalPods || 1
const podCpu = program.podCpu || 1
const podMem = program.podMem || '1Gi'
const podName = program.podName || 'redis'
const outputFile = program.file || 'redis.yaml'
