...
- pipeline: "Update Integration Config"
  ...
  - action: "Execute: update integration"
    ...
    - ""
    - "# Prod"
    - "export LUCKY_PROJECT=lucky-orange"
    - "node ./common/scripts/install-run-rush.js update-integration"
    - ""
    - "# Staging"
    - "export LUCKY_PROJECT=lucky-orange-staging"
    - "node ./common/scripts/install-run-rush.js update-integration"
...
- pipeline: "Backend: Prod"
  ...
  - action: "Execute: rush build"
    ...
    - "# Run build script"
    - "node ./common/scripts/install-run-rush.js build -t {{ name }}-backend"
    - ""
    mount_filesystem_path: "/buddy/workdir"
    shell: "BASH"
    trigger_condition: "ALWAYS"
  - action: "Deploy: Kubernetes"
    ...
    trigger_condition: "ALWAYS"
    integration_hash: "5dde343a422f5a6e5bb68886"
...
- pipeline: "Core: Prod"
  ...
  - action: "Execute: rush build"
    ...
    docker_image_tag: "14"
    execute_commands:
    - "node ./common/scripts/install-run-rush.js build -t {{ name }}-core"
    volume_mappings:
    - "/:/buddy/workdir"
    trigger_condition: "ALWAYS"
    shell: "BASH"
  - action: "Deploy: Cloud Storage"
    ...
    bucket_name: "lucky-orange-public"
    application_name: "lucky-orange"
    application_display_name: "lucky-orange"
    integration_hash: "rG7YBDXMVyb8W63lavAZEJ24gN"
...
- pipeline: "Privacy: Prod"
  ...
  - action: "Execute: rush build"
    ...
    docker_image_tag: "14"
    execute_commands:
    - "node ./common/scripts/install-run-rush.js build -t {{ name }}-privacy"
    volume_mappings:
    - "/:/buddy/workdir"
    trigger_condition: "ALWAYS"
    shell: "BASH"
